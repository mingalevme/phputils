...
final class FilesizeTest extends TestCase
{
     ...
     */
    public function testHumanize($humanSize, $byteSize, $precision, $useBinaryPrefix, $exception = null, $emessage = null): void
    {
        if ($exception) {
     ...
     */
    public function testDehumanize($byteSize, $humanSize, $exception = null, $emessage = null): void
    {
        if ($exception) {
            $this->expectException($exception, $emessage);
        }
    ...
    public static function dehumanizeDataProvider(): array
    {
        return [
            [1 * pow(1024, 1), '1024'],
            [1 * pow(1024, 1), '1024B'],
